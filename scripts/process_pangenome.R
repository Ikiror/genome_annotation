...
# 0) Inputs
# -----------------
wd <- "/data/users/aikiror/genomeAnnotation/output/19_create_bed_file/genespace_workingDir" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "Est0" # Your focal accession name
