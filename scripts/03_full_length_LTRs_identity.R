...
#-------------------------------------------------
gff_file <- "/data/users/aikiror/genomeAnnotation/output/01_EDTA/pacbio_hifi_Est-0.p_ctg.fa.mod.EDTA.raw/pacbio_hifi_Est-0.p_ctg.fa.mod.LTR.intact.raw.gff3"
cls_file <- "/data/users/aikiror/genomeAnnotation/output/02_clade_separation/pacbio_hifi_Est-0.p_ctg.fa.mod.LTR.raw.fa.rexdb-plant.cls.tsv"
...
ggsave("plots/03_LTR_Copia_Gypsy_cladelevel.png", combined, width = 12, height = 10, dpi = 300)
ggsave("plots/03_LTR_Copia_Gypsy_cladelevel.pdf", combined, width = 12, height = 10)