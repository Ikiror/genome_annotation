...
data <- "/data/users/aikiror/genomeAnnotation/output/01.6_EDTA/pacbio_hifi_Est-0.p_ctg.fa.mod.EDTA.anno/pacbio_hifi_Est-0.p_ctg.fa.mod.out.landscape.Div.Rname.tab"
